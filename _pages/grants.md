...
<p style="font-size: 1.5rem; font-weight: bold; margin-bottom: 1rem;">Jeffrey Carver has been awarded a total of ${{ total | number_with_delimiter }} in funding as PI or Co-PI.</p>

## Active Grants

{% include active_grants.liquid %}
